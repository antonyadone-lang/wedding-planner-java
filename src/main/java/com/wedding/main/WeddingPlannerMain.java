package com.wedding.main;

import com.wedding.dao.InvitatoDAO;
import com.wedding.model.Catering;
import com.wedding.model.Compiti;
import com.wedding.model.Dj;
import com.wedding.model.Fiorista;
import com.wedding.model.Fotografo;
...
import com.wedding.model.Testimone;
import com.wedding.model.TipoFornitore;
import com.wedding.service.FornitoreFactory;
import com.wedding.service.IWeddingManager;
import com.wedding.service.WeddingManager;
import com.wedding.service.WeddingManagerSQL;
import com.wedding.util.AutoSaveTask;
import com.wedding.util.BudgetSuperatoException;
import com.wedding.util.InvitatoNonTrovatoException;
import com.wedding.util.OrdinamentoPerCognome;
import com.wedding.util.OrdinamentoPerStato;
...
public class WeddingPlannerMain {
    static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        // ========== TEST GENERICS (com.wedding.util.RisultatoOperazione) ==========
        ...
        System.out.println("\n=== TEST HASHMAP (Ricerca per ID) ===");
        System.out.println("ID com.wedding.model.Fiorista: " + fiorista1.getIdServizio());
        System.out.println("ID com.wedding.model.Fotografo: " + fotografo1.getIdServizio());
        System.out.println("ID com.wedding.model.Dj: " + dj1.getIdServizio());
        System.out.println("ID com.wedding.model.Catering: " + catering1.getIdServizio());
        ...
        // ========== TEST CUSTOM EXCEPTION (com.wedding.util.TavoloPienoException) ==========
        System.out.println("\n=== TEST CUSTOM EXCEPTION - com.wedding.model.Tavolo Pieno ===");
        ...
        Invitato builderTest1 = new Invitato.Builder("Fabrizio", "Signorini", "fabrizio.signorini@gmail.com")
                ...
                .build();
        System.out.println("com.wedding.model.Invitato 1 (completo):");
        ...
        ServiziMatrimonio cateringFactory = FornitoreFactory.creareFornitore(
                ...
                "com.wedding.model.Catering Deluxe",
        ...
        ((WeddingManagerSQL) weddingManager).ricaricaDalDB();
        ...
        while(scelta != 0) {
            System.out.println("\nMenu:");
            System.out.println("1. Aggiungi com.wedding.model.Invitato (Simulazione)");
            System.out.println("2. Conferma com.wedding.model.Invitato");
            ...
            if (scelta == 1) {
                ...
                System.out.println("com.wedding.model.Invitato aggiunto correttamente!");
            }else if (scelta == 2) {
                System.out.println("--- DEBUG: Lista Invitati in Memoria ---");
                for (Invitato inv : weddingManager.getListaInvitati()) {
                    System.out.println(inv.getNome() + " " + inv.getCognome() + " - " + inv.getEmail());
                }
                System.out.println("----------------------------------------");
